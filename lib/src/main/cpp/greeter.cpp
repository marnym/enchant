...
#include "dev_nyman_enchant_kotlin_Greeter.h"
...
JNIEXPORT jstring JNICALL Java_dev_nyman_enchant_kotlin_Greeter_sayHello(JNIEnv * env, jobject self, jstring name_from_java) {
